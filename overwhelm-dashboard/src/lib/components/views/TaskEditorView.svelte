            ...
            <div class="flex flex-col gap-2 mt-1">
                ...
                {:else}
                    ...
                    <div class="flex gap-2 mt-1">
                        ...
                        <button
                            class="flex-1 py-1.5 border border-primary/40 {task.status === 'decomposing' ? 'bg-primary/20 border-primary text-primary' : 'text-primary/60'} hover:border-primary hover:text-primary font-bold text-[10px] transition-all rounded-sm disabled:opacity-50"
                            onclick={() => setStatus('decomposing')}
                            disabled={updating}
                        >
                            DECOMPOSING
                        </button>
