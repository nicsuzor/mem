...
{:else}
    ...
    {:else if $viewSettings.mainTab === "Insights"}
        <section class="{$selection.activeNodeId || $selection.activeSessionId ? 'col-span-9' : 'col-span-12'} flex flex-col h-full bg-background overflow-hidden transition-all"><InsightsView /></section>
