                        ...
                        "subtasks": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    ...
                                    "intent": { "type": "integer", "description": "Intent band 0-4 (P0 Critical .. P4 Backlog). Default when unset: P3 (Planned). Agents may set this under Nic's standing delegation — from his strategic context read across the graph, never the agent's own view of the subtask's importance, and never copied from the parent or a sibling." },
