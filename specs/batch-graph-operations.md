...
source: mem/docs/specs/batch-graph-operations.md
status: ready
tags:
- batch-ops
- graph
...
- pkb
- spec
title: 'Spec: Batch Task Graph Operations'
type: spec
---
...
| Project | `--project aops` | `project: "aops"` | Match `project` field (polecat repo slug — see [[TAXONOMY]] §"Project (operational routing field)") |
...
{
  "tool": "batch_reparent",
  "filters": { "project": "aops", "title_contains": "Write spec for" },
...
{
  "tool": "batch_update",
  "filters": { "project": "aops", "stale_days": 90, "priority_gte": 3 },
